...
public class QuicServerBootstrap {
    ...
    public QuicServerBootstrap(DataPlaneConfig cfg, TransferEngine engine) {
        this.cfg     = cfg;
        this.engine  = engine;
    ...
    private QuicSslContext buildSslContext() throws Exception {
        ...
        log.warn("No TLS cert configured — generating self-signed certificate (DEV ONLY)");
        return QuicSslContextBuilder
        ...
        return new QuicServerCodecBuilder()
                ...
                .streamHandler(new ChannelInitializer<QuicStreamChannel>() {
                    ...
                    protected void initChannel(QuicStreamChannel stream) {
                        stream.pipeline().addLast(new ChunkReceiver(eng, config, td));
                    }
                })
                .build();
    }
